...
<tileset version="1.10" tiledversion="1.12.2" name="connector" tilewidth="64" tileheight="64" tilecount="6" columns="2">
 <tileoffset x="0" y="16"/>
 <image source="connector.png" width="128" height="192"/>
